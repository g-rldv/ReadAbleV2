// ============================================================
// TeacherLayout.jsx — Redesigned to match ParentLayout style
// Soft pastels · Lucide icons · No emojis · Nunito + Fredoka One
// ============================================================
import { Outlet, NavLink, useNavigate } from 'react-router-dom';
import { useAuth } from '../../contexts/AuthContext';
import {
  BookOpen, Home, ClipboardList, School,
  FileText, LogOut, Menu, X, GraduationCap,
} from 'lucide-react';
import { useState } from 'react';

// ─── Design tokens (mirrored from ParentLayout) ───────────────
const C = {
  page:      '#F2F0FA',
  white:     '#FFFFFF',
  border:    '#DDD8F2',
  ...
  return (
    ...
    >
      <div style={{
        ...
        padding: 22, fontFamily: '"Nunito", sans-serif',
      }}>
        <h3 style={{
          fontFamily: '"Fredoka One", cursive',
          fontSize: 22, color: C.textPrimary, margin: '0 0 6px',
        }}>
          Sign out?
        </h3>
        <p style={{
  ...
  return (
    <NavLink
      ...
      style={({ isActive }) => ({
        ...
        background: isActive ? C.teacher.accentLight : 'transparent',
        color:      isActive ? C.teacher.accent      : C.textSecondary,
        border:     isActive
          ? `1.5px solid ${C.teacher.border}`
          : '1.5px solid transparent',
      })}
    >
      {({ isActive }) => (
        <>
          <Icon size={15} style={{ color: isActive ? C.teacher.accent : C.textMuted }} />
          {label}
        </>
      )}
    </NavLink>
      ...
      {({ isActive }) => (
        <>
          <div style={{
            ...
            background: isActive ? C.teacher.iconBg : '#F0EDF8',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
          }}>
            <Icon size={17} style={{ color: isActive ? C.teacher.accent : C.textMuted }} />
          </div>
          {label}
        </>
      )}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
              ...
              >
                <div style={{
                  ...
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  fontSize: 11, fontWeight: 800, color: C.teacher.accent,
                  fontFamily: '"Fredoka One", cursive',
                }}>
                  {initials}
                </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  background: C.teacher.iconBg,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  fontSize: 14, fontWeight: 800, color: C.teacher.accent,
                ...
                <div>
                  ...
                  <p style={{ fontSize: 11, color: C.textMuted, margin: 0, display: 'flex', alignItems: 'center', gap: 4 }}>
                    <GraduationCap size={11} /> Teacher account
                  </p>
                </div>
              </div>
